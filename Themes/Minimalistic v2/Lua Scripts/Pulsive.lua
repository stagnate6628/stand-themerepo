...
menu.action(menu.my_root(), "Load Recommended Settings", {}, "If this is your first time using, you need to run this for the best experience.", function()
    menu.trigger_commands("blur 0;borderwidth 4;borderrounded on;tabswidth 56;tabsposition top;tabsalignment centre;tabslefticon on;tabsname off;tabsrighticon off;menuwidth 392;primary 00000000;commandinfotextposition bottom;spacer 4;border 191919;background 191919")
...
local animsp = 0.001
menu.slider(menu.my_root(),"Animation Speed", {"animationspeed"}, "", -2147483648, 2147483647, 100, 20, function(val) timer = time() animsp = val/100000 end)
local sep_height = 2/1080
menu.slider(menu.my_root(), "Seperator Height", {"seperatorheight"}, "", 0, 16, 2, 1, function(val) sep_height = val/1080 end)
local last_slot
